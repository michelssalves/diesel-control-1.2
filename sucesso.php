...
<body>
    <?php if($acao == 'alterarAbastecimento' || $acao== 'alterarVeiculo' || $acao=='cadastrarVeiculo'){?>
     <div >
        <img src="diesel-control-1.2/assets/img/sucessoAlterar.png" style="width:400px;;margin-left: 30px;">
    </div>
    <?php }?>
    <?php if($acao == 'excluir' || $acao== 'desativarVeiculo'){?>
     <div >
        <img src="diesel-control-1.2/assets/img/sucessoExcluir.png" style="width:400px;">
    </div>
    <?php }?>
</body>
</html>